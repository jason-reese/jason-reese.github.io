...
], function (FeatureLayer, SimpleFillSymbol, SimpleLineSymbol, ClassBreaksRenderer, Color) {

let incomeSteLayer = new FeatureLayer({
...
const incomeCntyLayer = new FeatureLayer({
